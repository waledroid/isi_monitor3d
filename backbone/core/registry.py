...
Used at exactly five seams: FrameSource, Detector, Tracker, Triangulator,
MetadataSink. Implementations register themselves with a name and are
instantiated by the orchestrator from YAML — they never instantiate each other.
"""
...
class Registry(Generic[T]):
    ...
    def register(self, name: str) -> Callable[[type[T]], type[T]]:
        """Decorator: `@registry.register("rtsp")` on a concrete class."""
