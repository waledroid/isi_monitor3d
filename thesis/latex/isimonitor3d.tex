...
The \texttt{pallet3} corpus contains 5{,}540 training and 1{,}049 validation images for three classes: \texttt{palette} (pallet), \texttt{carton}, and \texttt{polybag}. A provenance audit confirmed that all images are real photographs. No independent test set was available; therefore, all reported accuracy is based on the validation split, and the reported checkpoints were selected on the same splits.
